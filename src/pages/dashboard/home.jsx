...
function Home() {
  ...
  return (
    <div className="container mt-12">
      <div className="mb-12 grid gap-y-6 gap-x-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
      ...
      <div className="mb-6 grid grid-cols-1 gap-y-8 gap-x-6 md:grid-cols-2 lg:grid-cols-3">
